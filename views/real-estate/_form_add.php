...
JS;
    ...
    $checkJs = 'var form = null; saveAddress(form);';
}
        ...
        $.ajax({
		  ...
		  dataType: 'html'
		   ...
		   $('#_modal-message').arcticmodal();	
                  ...
                  setTimeout(function(){ window.location.replace('/real-estate'); }, delay);
		});
    }
"
);
...
<div class="modal__body modal__body--big">
	...
	<?= Html::submitButton($actionButtonLabel, ['class' => 'btn btn-y modal--big__input__button __submit']) ?>
	<?php ActiveForm::end(); ?>
