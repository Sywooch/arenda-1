	...
	<div class="header-lk  js-header-lk">
		...
		<div class="header-lk__mobilePoint header-lk__mobi-container js-burger-menu"
			...
			<div class="b-mainlk-nav__item b-mainlk-nav__item--m ">
				<a onclick="window.location=$(this).attr('href);" href="<?= Url::to(['/real-estate/']) ?>">Недвижимость</a>
			</div>
			<div class="b-mainlk-nav__item b-mainlk-nav__item--m ">
				<a onclick="window.location=$(this).attr('href);" href="<?= Url::to(['/lease-contracts/']) ?>">Договор найма</a>
			</div>
			<div class="b-mainlk-nav__item b-mainlk-nav__item--m ">
				<a onclick="window.location=$(this).attr('href);" href="<?= Url::to(['/applications']) ?>">Заявки</a>
			</div>
			<div class="b-mainlk-nav__item b-mainlk-nav__item--m ">
				<a onclick="window.location=$(this).attr('href);" href="<?= Url::to(['/scrining/requests']) ?>">Проверка нанимателей</a>
			</div>
			<div
				class="b-mainlk-nav__item b-mainlk-nav__item--m  <?= $str->contain($page, 'payment-methods', 'is-active') ?>">
		...
		<div class="wrapper-lk">
			...
			<div class="header-lk__nav">
				...
				<div class="b-mainlk-nav is-active  js-main-nav-lk">
					...
					<div class="b-mainlk-nav__item  <?= $str->contain($page, 'real-estate', 'is-active') ?>">
						<a href="<?= Url::to(['/real-estate/']) ?>">Недвижимость</a>
						<div class="b-mainlk-nav__line"></div>
					</div>


					<div class="b-mainlk-nav__item <?= $str->contain($page, 'lease-contracts', 'is-active') ?>">
						<a href="<?= Url::to(['/lease-contracts/']) ?>">Договор найма</a>
						<div class="b-mainlk-nav__line"></div>
					</div>
					...
					<div class="b-mainlk-nav__item <?= $str->contain($page, 'applications', 'is-active') ?>">
						<a href="<?= Url::to(['/applications']) ?>">
							Заявки
							<?php if (isset(Yii::$app->params['new_app_counter']) && Yii::$app->params['new_app_counter'] > 0): ?>
								<div class="b-mainlk-nav__counter"><?= Yii::$app->params['new_app_counter']; ?></div>
							<?php endif; ?>
						</a>
						<div class="b-mainlk-nav__line"></div>
					</div>
					...
					<div class="b-mainlk-nav__item <?= $str->contain($page, 'scrining/requests', 'is-active') ?> ">
						<a href="<?= Url::to(['/scrining/requests']) ?>">
					...
					<div class="b-mainlk-nav__item <?= $str->contain($page, 'user/profile', 'is-active') ?> ">
						<a
							onclick="window.location = $(this).attr('href')"
							href="<?= Url::to(['/user/profile']) ?>">Профиль</a>
						<div class="b-mainlk-nav__line"></div>
					</div>
				...
				<div class="b-mainlk-nav-m  js-main-nav-select-lk">
					<div class="b-mainlk-nav-m__current">
                        <?php
                        if($str->contain($page, 'real-estate',true)){ echo 'Недвижимость'; }
                        elseif($str->contain($page, 'lease-contracts',true)){ echo 'Договор найма'; }
                        elseif($str->contain($page, 'applications',true)){ echo 'Заявки'; }
                        elseif($str->contain($page, 'scrining/requests',true)){ echo 'Проверка нанимателей'; }
                        elseif($str->contain($page, 'payment-methods',true)){ echo 'Карты и счета'; }
                        elseif($str->contain($page, 'user/profile',true)){ echo 'Профиль'; }
                        else{ echo 'Недвижимость'; }
                        ?>
                        </div>
					<div class="b-mainlk-nav-m__items is-active">
                        <div class="b-mainlk-nav-m__item  <?= $str->contain($page, 'real-estate', 'is-active') ?>">
                            <a onclick="window.location = $(this).attr('href')" href="<?= Url::to(['/real-estate/']) ?>">Недвижимость</a>
                            <div class="b-mainlk-nav__line"></div>
                        </div>

                        <div class="b-mainlk-nav-m__item <?= $str->contain($page, 'lease-contracts', 'is-active') ?>">
                            <a onclick="window.location = $(this).attr('href')" href="<?= Url::to(['/lease-contracts/']) ?>">Договор найма</a>
                            <div class="b-mainlk-nav__line"></div>
                        </div>

                        <div class="b-mainlk-nav-m__item <?= $str->contain($page, 'applications', 'is-active') ?>">
                            <a onclick="window.location = $(this).attr('href')" href="<?= Url::to(['/applications']) ?>">
                                Заявки
                                <?php if (isset(Yii::$app->params['new_app_counter']) && Yii::$app->params['new_app_counter'] > 0): ?>
                                    <div class="b-mainlk-nav__counter"><?= Yii::$app->params['new_app_counter']; ?></div>
                                <?php endif; ?>
                        ...
                        <div class="b-mainlk-nav-m__item <?= $str->contain($page, 'scrining/requests', 'is-active') ?> ">
                            <a onclick="window.location = $(this).attr('href')" href="<?= Url::to(['/scrining/requests']) ?>">
                                Проверка нанимателей
                            </a>
                            <div class="b-mainlk-nav__line"></div>
                        </div>

                        <div class="b-mainlk-nav-m__item <?= $str->contain($page, 'payment-methods', 'is-active') ?>">
                            <a onclick="window.location = $(this).attr('href')" href="<?= Url::to(['/payment-methods']) ?>">Карты и счета</a>
                            <div class="b-mainlk-nav__line"></div>
                        </div>

                        <div class="b-mainlk-nav-m__item <?= $str->contain($page, 'user/profile', 'is-active') ?> ">
                            <a
                                    onclick="window.location = $(this).attr('href')"
                                    href="<?= Url::to(['/user/profile']) ?>">Профиль</a>
                            <div class="b-mainlk-nav__line"></div>
			...
			<div class="header-lk__user-nav">
				<div class="b-userlk-nav js-click-is-active">
					...
					<div class="b-userlk-nav__sub-list js-click-toggle-active <?= $action = 'user/profile' ?> ">
						<div
							class="b-userlk-nav__title <?= $str->contain($page, 'settings/notifications', 'is-active') ?>">
							<?= Html::a('Настройки', Url::to(['/settings/notifications'])); ?>
						</div>
