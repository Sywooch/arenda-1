...
<html lang="ru"><head>
    ...
    <style>
        ...
        *:before{
        ...
        .top-info__col--lg{width:48%}
        .top-info__col--md{width:30%}
    ...
    <style>
        ...
        .rating-chart--negative .rating-chart__pointer{background-image: url('/pdf-pages/pdf-img/rating-pointer-bad.png');}
    </style>
...
<?php if(isset($model->status) AND $model->status=='DONE'){?>
        ...
        <div class="panel padd-wrapper">
            ...
            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inline item-check--valid">
                    ...
                    <div class="item-check item-check--inline item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--phone">
                                <svg viewBox="0 0 15.3009 17.8861"><path d="M3.5986,16.066v-1.4451h7.9622c0,0,0,0.8784,0,1.0201c0,0.4534-0.0283,0.7084-0.255,1.0201
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            ...
            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--valid">
                        <div class="item-check__ico-wr">
		...
		C2.4765,1.7127,2.4482,2.1377,2.4482,2.7894v7.5371C2.4482,10.9499,2.4765,11.63,2.4482,12.225z"></path>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--invalid">
                        <div class="item-check__ico-wr">
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            ...
            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inline item-check--invalid">
                        <div class="item-check__ico-wr">
