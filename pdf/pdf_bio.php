...
<html lang="ru"><head>
    ...
    <title>Отчёт о личных данных</title>
...
<div style="display:none;">
	...
	s23.8324-10.6899,23.8324-23.8299S42.0582,5.0895,28.917,5.0895z"/>
        </symbol>
		...
		C2.4765,1.7127,2.4482,2.1377,2.4482,2.7894v7.5371C2.4482,10.9499,2.4765,11.63,2.4482,12.225z"/>
        </symbol>
		...
		c-0.1983,0.4817-0.51,0.5667-0.6234,0.7367c0.085,0.1983,0.1983,0.3967,0.2834,0.595L16.1489,8.5585z"/>
        </symbol>
	...
	<path  d="M3.4002,3.4077c0.2267-0.0567,5.0436-0.0283,5.7237,0c3.1452,0,3.1452-0.3117,3.1452,1.1617v11.504
		...
		c0,0.8217-0.1133,1.5584,0.3967,2.0685c0.425,0.3967,0.7934,0.3684,1.5018,0.3684H11.2774z"/>
</symbol>
        ...
        <symbol id="phone" viewBox="0 0 15.3009 17.8861">
			...
			V3.0319c0-1.0201,0.1133-1.5301-0.425-2.2385C11.334,0.1417,10.7673,0,9.9739,0H5.1003C3.7119,0,2.8618,0.8501,2.8618,2.2385z"/>
        </symbol>
        ...
        <symbol id="town" viewBox="0 0 21.1163 17.8667">
			...
			L7.8256,4.3636C7.9389,4.2786,12.8692,1.4451,13.0392,1.4168z"/>
        </symbol>
        ...
        <symbol id="policeman" viewBox="0 0 15.3009 17.7957">
			...
			C4.2786,7.3573,4.4769,7.754,4.732,8.1223c0.0567,0.085,0.1133,0.17,0.1983,0.2267C5.0153,8.434,5.072,8.4907,5.1286,8.5757z"/>
        </symbol>
        ...
        <symbol id="drugs" viewBox="0 0 19.046 17.8634">
			...
			c0.1417-0.1417,0.1983-0.3117,0.085-0.51c-0.085-0.17-0.5384-0.5667-0.68-0.7367C14.1959,5.3563,13.7425,4.9313,13.6575,4.7896z"/>
        </symbol>
		...
		c-0.0283-0.9351-0.34-1.8134-0.9067-2.5502C13.4511,3.2167,12.2894,2.65,11.0143,2.5367z"/>
        </symbol>
        ...
        <symbol id="map" viewBox="0 0 16.9727 17.6006">
			...
			C12.5524-0.5622,10.2006,0.1178,9.1522,1.9313z"/>
        </symbol>
        <symbol id="money" viewBox="0 0 17.844 17.8316">
			...
			c-0.6517-0.4534-1.4734-0.6234-2.2951-0.51C12.857,2.3312,12.6304,2.4445,12.4037,2.4729z"/>
        </symbol>
    </svg>
</div>
...
<?php if(isset($model->status) AND $model->status=='DONE'){?>
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            <h3 class="panel-title">1. Анализ данных</h3>

            <div class="progress">
                <div class="progress__line">
                    <div class="progress__progress" style="width: <?php if($model->data->decision->decisionBinnar==1){
                        echo '100';
                   }else{
                        echo '100';
                    } ?>%">
                        <div class="progress__status-gr">
                            <span class="progress__status-visual"></span>
                            <span class="progress__status-numb"><?php if($model->data->decision->decisionBinnar==1){
                                    echo '100';
                                }else{
                                    echo '100';
                                } ?>%</span>
            ...
            <p>
                <?php if($model->data->decision->decisionBinnar==1){ ?>
                    Протеворечий не найдено
                <?php }else{ ?>
                    Протеворечий найдено
                <?php } ?>
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            <h3 class="panel-title">2. Личные данные</h3>

            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--<?php if($model->data->decision->decisionBinnar==1){ echo 'valid'; }else{ echo 'invalid'; } ?>">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--passport">
                                <svg viewBox="0 0 15.3009 17.8307">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#passport"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p>
                                <?php if($model->data->decision->decisionBinnar==1){ ?>
                                    Соответсвует с завленным данным
                                <?php }else{ ?>
                                    Не соответствует<br>
                                    заявленным данным
                                <?php } ?>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--<?php if(isset($model->data->rscb->phone)){ echo 'valid'; }else{ echo 'invalid'; } ?>">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--phone">
                                <svg viewBox="0 0 15.3009 17.8861">
                        ...
                        <div class="item-check__txt-wr">
                            <p>
                                <?php if(isset($model->data->rscb->phone)){ ?>
                                    Телефон<br>
                                    подтвержден
                                <?php }else{ ?>
                                    Телефон не<br>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--town">
                                <svg viewBox="0 0 21.1163 17.8667">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#town"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p>
                                <?php echo $report->post_code; ?>,<br>
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            <h3 class="panel-title">3. Нарушения</h3>

            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--<?php if(isset($model->data->fssp->result) AND $model->data->fssp->result==1){ echo 'invalid'; }else{ echo 'valid'; } ?>">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--paper">
                                <svg viewBox="0 0 57.8391 57.839">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#papers"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p class="item-check__title">Исполнительное производство</p>
                            <p class="item-check__status">
                                <?php if(isset($model->data->fssp->result) AND $model->data->fssp->result==0){ ?>
                                    Сведений о исполнительном<br>
                                    производстве не найдено
                                <?php } ?>
                                </p>
                        </div>
                    </div>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--<?php if(isset($model->data->fssp->fssp) AND count($model->data->fssp->fssp)>0){ echo 'invalid'; }else{ echo 'valid'; } ?>">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--judge">
                                <svg viewBox="0 0 57.8391 57.839">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#judge"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p class="item-check__title">Административные правонарушения</p>
                            <p class="item-check__status">
                                <?php if(isset($model->data->fssp->fssp) AND count($model->data->fssp->fssp)>0){ ?>
                                    Найдены сведенья об исполнительном <br>
                                    делопроизводстве в отношении ФЛ
                                <?php } ?>
                            </p>
                        </div>
                    </div>
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            <h3 class="panel-title">4. База данных</h3>

            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--policeman">
                                <svg viewBox="0 0 15.3009 17.7957">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#policeman"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p class="item-check__title">Федеральный розыск</p>
                            <p class="item-check__status">
                                Сведенья<br>
                                отсутсвуют</p>
                        </div>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--drugs">
                                <svg viewBox="0 0 19.046 17.8634">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#drugs"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p class="item-check__title">БД наркозависимых</p>
                            <p class="item-check__status">
                                Сведенья<br>
                                отсутсвуют</p>
                        </div>
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--lupa">
                                <svg viewBox="0 0 17.744 17.7289">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lupa"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
                            <p class="item-check__title">БД подучетных лиц</p>
                            <p class="item-check__status">
                                Сведенья<br>
                                отсутсвуют</p>
                        </div>
    ...
    <section class="wrapper">
        <div class="panel padd-wrapper">
            <h3 class="panel-title">5. Работа</h3>

            <div class="panel__cols">
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--map">
                                <svg viewBox="0 0 16.9727 17.6006">
                ...
                <div class="panel__col panel__col--33">
                    <div class="item-check item-check--inlinewrong item-check--valid">
                        <div class="item-check__ico-wr">
                            <div class="circle-icon circle-icon--money">
                                <svg viewBox="0 0 17.844 17.8316">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#money"></use>
                                </svg>
                            </div>
                        </div>
                        <div class="item-check__txt-wr">
